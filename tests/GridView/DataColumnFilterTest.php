    ...
    public function testFilterDate(): void
    {
        Assert::equalsWithoutLE(
            ...
            GridView::widget()
                ...
                ->id('w1-grid')
                ->paginator($this->createOffsetPaginator($this->dataWithDate, 10, 1))
                ->translator(Mock::translator('en'))
                ->urlGenerator(Mock::urlGenerator([Route::get('/admin/manage')->name('admin/manage')]))
                ->render()
        );
    ...
    public function testFilterDateTime(): void
    {
        Assert::equalsWithoutLE(
            ...
            GridView::widget()
                ...
                ->id('w1-grid')
                ->paginator($this->createOffsetPaginator($this->dataWithDateTime, 10, 1))
                ->translator(Mock::translator('en'))
                ->urlGenerator(Mock::urlGenerator([Route::get('/admin/manage')->name('admin/manage')]))
                ->render()
        );
    ...
    public function testFilterEmail(): void
    {
        Assert::equalsWithoutLE(
            ...
            GridView::widget()
                ...
                ->id('w1-grid')
                ->paginator($this->createOffsetPaginator($this->dataWithEmail, 10, 1))
                ->translator(Mock::translator('en'))
                ->urlGenerator(Mock::urlGenerator([Route::get('/admin/manage')->name('admin/manage')]))
                ->render()
        );
    ...
    public function testFilterMonth(): void
    {
        Assert::equalsWithoutLE(
            ...
            GridView::widget()
                ...
                ->id('w1-grid')
                ->paginator($this->createOffsetPaginator($this->dataWithMonth, 10, 1))
                ->translator(Mock::translator('en'))
                ->urlGenerator(Mock::urlGenerator([Route::get('/admin/manage')->name('admin/manage')]))
                ->render()
        );
    ...
    public function testFilterTelephone(): void
    {
        Assert::equalsWithoutLE(
            ...
            GridView::widget()
                ...
                ->filterRowAttributes(['class' => 'text-center'])
                ->id('w1-grid')
                ->paginator($this->createOffsetPaginator($this->dataWithTelephone, 10, 1))
                ->translator(Mock::translator('en'))
                ->urlGenerator(Mock::urlGenerator([Route::get('/admin/manage')->name('admin/manage')]))
                ->render()
        );
    ...
    public function testFilterTime(): void
    {
        Assert::equalsWithoutLE(
            ...
            GridView::widget()
                ...
                ->filterRowAttributes(['class' => 'text-center'])
                ->id('w1-grid')
                ->paginator($this->createOffsetPaginator($this->dataWithTime, 10, 1))
                ->translator(Mock::translator('en'))
                ->urlGenerator(Mock::urlGenerator([Route::get('/admin/manage')->name('admin/manage')]))
                ->render()
        );
    ...
    public function testFilterWeek(): void
    {
        Assert::equalsWithoutLE(
            ...
            GridView::widget()
                ...
                ->filterRowAttributes(['class' => 'text-center'])
                ->id('w1-grid')
                ->paginator($this->createOffsetPaginator($this->dataWithWeek, 10, 1))
                ->translator(Mock::translator('en'))
                ->urlGenerator(Mock::urlGenerator([Route::get('/admin/manage')->name('admin/manage')]))
                ->render()
        );
