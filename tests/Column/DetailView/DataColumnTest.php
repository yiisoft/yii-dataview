        ...
        Assert::equalsWithoutLE(
            ...
            DetailView::widget()
                ->columns(
                    ...
                    DataColumn::create()->attribute('isAdmin')->labelAttributes(['class' => 'test-class']),
                )
        ...
        Assert::equalsWithoutLE(
            ...
            DetailView::widget()
                ->columns(
                    DataColumn::create()->attribute('id'),
                    DataColumn::create()->attribute('username'),
                    DataColumn::create()->attribute('isAdmin')->labelTag('p'),
                )
                ->data(['id' => 1, 'username' => 'admin', 'isAdmin' => true])
                ->render(),
        );
        ...
        Assert::equalsWithoutLE(
            ...
            DetailView::widget()
                ->columns(
                    DataColumn::create()->attribute('id'),
                    DataColumn::create()->attribute('username'),
                    DataColumn::create()->attribute('isAdmin')->value(1),
                )
        ...
        Assert::equalsWithoutLE(
            ...
            DetailView::widget()
                ->columns(
                    DataColumn::create()->attribute('id'),
                    DataColumn::create()->attribute('username'),
                    DataColumn::create()->attribute('isAdmin')->valueTag('p'),
                )
                ->data(['id' => 1, 'username' => 'admin', 'isAdmin' => true])
                ->render(),
        );
