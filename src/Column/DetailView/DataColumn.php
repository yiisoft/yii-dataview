...
namespace Yiisoft\Yii\DataView\Column\DetailView;

use Closure;

/**
 * DataColumn is the default column type for the {@see DetailView} widget.
 *
...
final class DataColumn
{
    ...
    /**
     * Return new instance of DataColumn with specified attribute.
     *
